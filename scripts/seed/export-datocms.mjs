...
const SITE_CONTENT = {
  ...
  homeContent: {
    ...
    random_sentences: [
      "Hello we’re nine creative agency",
      "Hello we’re your new creative agency",
      "It’s time to shine.",
      "This is where the magic happens.",
      "We’re a strong strategic and creative agency with offices in Breda and Rotterdam.",
      "9|CA: Built on friendship, fueled by creativity and passion.",
      "We’ve a desire to drive real positive change through our work.",
      "With creative power and smart strategy, we help businesses take off.",
      "Bold, impactful ideas that grab attention and deliver real results.",
      "No fluff, no fuss, just creativity that works.",
      "A brand story that makes sense.",
      "What can we do for you?",
      "Where bold ideas meet sharp execution, magic happens",
      "We don’t follow trends. We set the pace for what’s next.",
      "Great design turns brands into experiences you can’t forget.",
      "Our design makes brands impossible to ignore.",
      "Timeless over trendy, always.",
      "Not just a pretty face.",
      "Great design sparks conversations.",
      "It’s all in the details.",
      "Less noise, more meaning.",
      "Make it iconic.",
      "We make campaigns that stick.",
    ].map((text) => ({ text })),
  },
  cookieBanner: {
    cookie_message:
